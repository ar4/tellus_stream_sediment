...
def load_inputs(input_csv, flow_directions_file):
...
def run(output_file, input_csv, flow_directions_file):
    """Main driver function.
    """

    (input_df, flow_directions, coordTrans, geoTrans) = load_inputs(input_csv, flow_directions_file)
...
if __name__ == '__main__':
    ...
    run(args.output, args.measurements, args.flow_directions)
